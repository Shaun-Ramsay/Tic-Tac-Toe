...
def game():
    ...
    box1 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box1))
    box1.grid(row = 1, column = 0, padx = 1, pady = 1)

    box2 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box2))
    box2.grid(row = 1, column = 1, padx = 1, pady = 1)

    box3 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box3))
    box3.grid(row = 1, column = 2, padx = 1, pady = 1)

    box4 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box4))
    box4.grid(row = 2, column = 0, padx = 1, pady = 1)

    box5 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box5))
    box5.grid(row = 2, column = 1, padx = 1, pady = 1)

    box6 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box6))
    box6.grid(row = 2, column = 2, padx = 1, pady = 1)

    box7 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box7))
    box7.grid(row = 3, column = 0, padx = 1, pady = 1)

    box8 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box8))
    box8.grid(row = 3, column = 1, padx = 1, pady = 1)

    box9 = tk.Button(frame, text = Text, bg = 'black', fg = 'black', width = 5, height = 3, command=lambda: info(box9))
    ...
    def info(box):
        ...
        if Move == 1:
            ...
            if Row == 1 and Column == 0:
                new_box1 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box1.grid(row = Row, column = Column, padx = 1, pady = 1)
                text1 = new_box1['text']
            elif Row == 1 and Column == 1:
                new_box2 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box2.grid(row = Row, column = Column, padx = 1, pady = 1)
                text2 = new_box2['text']
            elif Row == 1 and Column == 2:
                new_box3 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box3.grid(row = Row, column = Column, padx = 1, pady = 1)
                text3 = new_box3['text']
            elif Row == 2 and Column == 0:
                new_box4 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box4.grid(row = Row, column = Column, padx = 1, pady = 1)
                text4 = new_box4['text']
            elif Row == 2 and Column == 1:
                new_box5 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box5.grid(row = Row, column = Column, padx = 1, pady = 1)
                text5 = new_box5['text']
            elif Row == 2 and Column == 2:
                new_box6 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box6.grid(row = Row, column = Column, padx = 1, pady = 1)
                text6 = new_box6['text']
            elif Row == 3 and Column == 0:
                new_box7 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box7.grid(row = Row, column = Column, padx = 1, pady = 1)
                text7 = new_box7['text']
            elif Row == 3 and Column == 1:
                new_box8 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box8.grid(row = Row, column = Column, padx = 1, pady = 1)
                text8 = new_box8['text']
            elif Row == 3 and Column == 2:
                new_box9 = tk.Button(frame, text = 'X', bg = 'black', fg = 'black', width = 5, height = 3)
            ...
            if Row == 1 and Column == 0:
                new_box1 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box1.grid(row = Row, column = Column, padx = 1, pady = 1)
                text1 = new_box1['text']
            elif Row == 1 and Column == 1:
                new_box2 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box2.grid(row = Row, column = Column, padx = 1, pady = 1)
                text2 = new_box2['text']
            elif Row == 1 and Column == 2:
                new_box3 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box3.grid(row = Row, column = Column, padx = 1, pady = 1)
                text3 = new_box3['text']
            elif Row == 2 and Column == 0:
                new_box4 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box4.grid(row = Row, column = Column, padx = 1, pady = 1)
                text4 = new_box4['text']
            elif Row == 2 and Column == 1:
                new_box5 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box5.grid(row = Row, column = Column, padx = 1, pady = 1)
                text5 = new_box5['text']
            elif Row == 2 and Column == 2:
                new_box6 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box6.grid(row = Row, column = Column, padx = 1, pady = 1)
                text6 = new_box6['text']
            elif Row == 3 and Column == 0:
                new_box7 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box7.grid(row = Row, column = Column, padx = 1, pady = 1)
                text7 = new_box7['text']
            elif Row == 3 and Column == 1:
                new_box8 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box8.grid(row = Row, column = Column, padx = 1, pady = 1)
                text8 = new_box8['text']
            elif Row == 3 and Column == 2:
                new_box9 = tk.Button(frame, text = 'O', bg = 'black', fg = 'black', width = 5, height = 3)
                new_box9.grid(row = Row, column = Column, padx = 1, pady = 1)
                text9 = new_box9['text']
